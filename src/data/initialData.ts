...
export const initialSEO: SEOConfig = {
  title: '우리회사 - 국가 표준 계측기 교정 & 공인 성적서 발급 전문',
  description: 'KOLAS 가이드라인 준수 계측기 정밀 교정 및 성적서 발급 전문 기업 우리회사입니다. 수질 연속 측정기, 복합 가스 분석기, 미세먼지 샘플러, 초음파 파쇄기 등 정밀 장비의 출장/내방 교정 서비스를 제공합니다.',
  keywords: '우리회사, 국가 표준 교정, 계측기 교정, 교정 성적서, 수질측정기 교정, 가스분석기 교정, 미세먼지 샘플러 교정, 초음파 파쇄기 교정'
};

export const initialSocials: SocialLinks = {
  facebook: 'https://facebook.com/wooricompany',
  linkedin: 'https://linkedin.com/company/wooricompany',
  youtube: 'https://youtube.com/wooricompany_official',
  instagram: 'https://instagram.com/wooricompany_env'
};

export const initialCompany: CompanyInfo = {
  name: '우리회사 (Woori Company)',
  ceo: '김홍도',
  address: '서울특별시 금천구 가산디지털1로 201, 에이스하이엔드타워 9차 1205호',
  phone: '02-555-1234',
  fax: '02-555-5678',
  email: 'info@wooricompany.co.kr',
...
export const initialAbout: AboutInfo = {
  introduction: '우리회사는 대기, 수질, 토양 등 지속 가능한 지구 환경을 위한 첨단 환경계측기와 산업용 초음파 장비의 국가 표준 교정 및 성적서 발급 전문 파트너입니다. 국가 표준에 소급된 최첨단 교정 표준 장비와 고정밀 기술을 통하여 대학, 국가 연구소, 환경 측정망 및 산업체에서 운용 중인 기기들의 높은 측정 신뢰도를 견인합니다.',
...
export const initialNotices: NoticePost[] = [
  ...
  },
  {
    ...
    content: '우리회사는 대기 및 수질 측정 기기와 초음파 파쇄 장비의 정확한 측정을 보증하기 위해, 국가 표준 물질(CRM)에 완벽히 소급된 고성능 표준 교정 서비스를 본격 시행하였습니다.\n\n본 교정 체계는 대기질 자동측정기 및 시료채취 장비의 기밀 누설, 흡입 유량, 가스 감도 원점을 정밀 보정하여, 연구 기관이 신뢰성 높은 데이터를 산출할 수 있도록 지원합니다. 김홍도 대표이사는 "장비를 판매하는 것에 그치는 시장에서, 정밀한 교정과 정도(精度) 관리를 통해 국가 측정 데이터의 신뢰성을 지탱하는 든든한 주춧돌이 되겠다"며 계측 신뢰성 강화에 대한 강력한 신념을 밝혔습니다.',
    category: '보도자료',
    author: '홍보실',
    date: '2026-05-15',
    views: 320
...
export const initialCompanyBeliefs = {
  ...
  subtitle: '우리회사의 3대 핵심 교정 신념 (Calibration Philosophy)',
  introText: '우리회사는 설립 이래, 대한민국 산업계와 공공 연구 기관의 정밀 측정 및 환경 계측 인프라가 정직하고 정밀하게 운영될 수 있도록 계측기 표준 교정 서비스를 선도해 왔습니다. 미세먼지 시료채취 장치의 오리피스 유량 적산 교정, 복합 가스 분석기의 감도 캘리브레이션, 그리고 하이테크 초음파 장비의 출력 정확도 검증에 이르기까지 국가 표준 규격 소급성 체계를 준수하며, 투명하고 정밀한 성적서를 약속합니다.',
  beliefs: [
    {
      id: 'b-1',
